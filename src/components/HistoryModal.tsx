...
export const HistoryModal: React.FC<HistoryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in">
      <div className="w-full max-w-2xl rounded-3xl glass-panel border border-purple-500/30 p-6 sm:p-8 shadow-2xl relative max-h-[85vh] flex flex-col">
        {/* Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                ประวัติการสุ่มล่าสุด 30 รายการที่ผ่านมา
              </p>
            </div>
          </div>
          ...
          {historyBuilds.length === 0 ? (
            ...
            historyBuilds.map((build) => {
              ...
              return (
                <div
                  key={build.id}
                  className="glass-panel p-3.5 rounded-2xl border border-white/10 hover:border-purple-500/40 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3 group"
                >
                  <div>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 pt-2 sm:pt-0 border-t sm:border-t-0 border-white/5">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 border border-purple-500/40 text-xs font-bold flex items-center gap-1 transition-all"
        ...
        {historyBuilds.length > 0 && (
          <div className="pt-4 border-t border-white/10 flex items-center justify-between shrink-0">
            ...
            >
              ล้างประวัติทั้งหมด (Clear History)
            </button>
            <button
              onClick={() => {
                playClickSound();
