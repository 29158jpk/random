...
const TEMP_USER_DATA = "C:/Users/Horizon/AppData/Local/Temp/chrome_test_click3";
    ...
    const test = await send("Runtime.evaluate", {
      expression: `
        (() => {
          ...
          if (spinBtn) {
            // Dispatch real bubbles event
            spinBtn.dispatchEvent(new MouseEvent('click', { bubbles: true, cancelable: true, view: window }));
            console.log("Dispatched bubbles click event!");
          }
